...
def parse_cli():
    ...
    parser.add_argument('-i',
                        ...
                        help='0MQ rendez-vous for message input', required=True)
...
def build_text_to_speech_cmdline(args):
    ...
    text_to_speech_command_line = args.espeack_path + ' -v fr-fr -s 150 --stdout "%s" '
    ...
    text_to_speech_command_line += args.sox_path + ' --no-show-progress -t wav - bass +1 pitch -300 echo 0.8 0.4 99 0.3'
